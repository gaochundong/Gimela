...
namespace Gimela.Presentation.Controls
{
  ...
  public class SprocketControl : Control
  {
    ...
    // The Lower limit of the Alpha value (The spokes will be shown in alpha values ranging from 255 to m_AlphaLowerLimit)
    ...
    public static readonly DependencyProperty TickStyleProperty =
        DependencyProperty.Register("TickStyle", typeof(PenLineCap), typeof(SprocketControl),
            new FrameworkPropertyMetadata(
                PenLineCap.Round, FrameworkPropertyMetadataOptions.AffectsRender,
    ...
    protected override void OnRender(DrawingContext dc)
    {
      ...
      for (int i = 0; i < TickCount; i++)
      {
        ...
        Pen p = new Pen(new SolidColorBrush(Color.FromArgb(
            alpha, this.TickColor.R, this.TickColor.G, this.TickColor.B)), TickWidth);
